...
void home_screen() {
    ...
    // tft.println(limit_db);
    // tft.println(limit_wb);
    // tft.setTextColor(TFT_RED);
    // tft.println(readIntFromEEPROM(EEPROM, flag1));
    //             tft.println(readIntFromEEPROM(EEPROM, flag2));
    //             tft.println(readIntFromEEPROM(EEPROM, sec1));
    //             tft.println(readIntFromEEPROM(EEPROM, sec2));
}
...
void loop() {
    ...
    temp_control();
            if(cur_time - pre_time >= 10 && selected_interface == 1 && cur_time_flag){
                pre_time = cur_time;
                second++;
                if(second == 10){
                    minute++;
